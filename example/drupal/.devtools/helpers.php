...
function server_pid_file(): string {
  ...
  return sprintf('/tmp/druxt-auth-drupal-php-server-%s.pid', hash('sha256', (string) getcwd()));
}
...
// @codeCoverageIgnoreStart
if (!function_exists('DruxtAuthDevTools\quit') && !class_exists('PHPUnit\\Framework\\TestCase')) {
